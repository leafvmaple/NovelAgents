...
export const enUS = {
  agent: {
    ...
    repairingJson: "{purpose} returned invalid structured data; repairing once…",
    analyzingRequest: "The requirements agent is preparing the novel specification…",
    creatingBlueprint: "The planning agent is creating the story bible and outline…",
    chapterAlreadySaved: "Chapter {chapter} is already saved; continuing with the next chapter.",
  ...
  review: {
    ...
    foreignWordsProblem: "The Chinese chapter contains untranslated English expressions: {words}.",
  ...
  cli: {
    specHeading: "Novel specification", title: "Title: {value}", genre: "Genre: {value}", tone: "Tone: {value}", pov: "Point of view: {value}",
    chapters: "Chapters: {count}, about {words} words each", logline: "Logline: {value}", planHeading: "Chapter plan",
    mockNotice: "OPENROUTER_API_KEY was not found. Using the offline demo provider.", resumedFrom: "Resuming from: {path}",
